				...
				<div class="carousel-outer">
					<div class="cab-carousel" id="cab-carousel">
						<div class="fleet-item">
							<img src="images/fleet-carousel-img.png" alt=""/>
						...
						<div class="col-md-4 col-sm-4 col-xs-6">
							<div class="deal-box">
								<figure class="deal-thumb">
									<img src="images/deals-img.png" alt=""/>
								</figure>
								<div class="deal-info">
									<h4>Oklahoma</h4>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<p>&copy; Copyrights 2020 <a href="/">Prime Cab</a>. All Rights Reserved.</p>
						</div>
						<div class="col-md-6 col-sm-6">
                                <p>Disclaimer | Developed by <a href="https://vmsl.com.bd">VMSL</a>.</p>
						</div>
					</div>
				</div>
			</section>
